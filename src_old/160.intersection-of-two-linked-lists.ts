...
/**
 * (Set - O(N) memory)Returns the intersection node of two linked lists.
 *
 * @param {ListNode | null} headA - the head of the first linked list
 * @param {ListNode | null} headB - the head of the second linked list
 * @return {ListNode | null} the intersection node if found, otherwise null
 */
...
// }
/**
 * (O(N) - timeLoop)Find the intersection node of two linked lists.
 *
 * @param {ListNode | null} headA - the head of the first linked list
 * @param {ListNode | null} headB - the head of the second linked list
 * @return {ListNode | null} the intersection node if exists, otherwise null
 */
// export function getIntersectionNode(
//   headA: ListNode | null,
//   headB: ListNode | null
...
//   let min = Math.min(lengthA, lengthB);
//   while (min < lengthA) {
//     lengthA--;
//     headA = headA!.next;
//   }
...
// }
/**
 * (double pointer)Finds the intersection node of two linked lists.
 *
 * @param {ListNode | null} headA - The head of the first linked list
 * @param {ListNode | null} headB - The head of the second linked list
 * @return {ListNode | null} The intersection node of the two linked lists, or null if there is no intersection
 */
export function getIntersectionNode(
  headA: ListNode | null,
  headB: ListNode | null
